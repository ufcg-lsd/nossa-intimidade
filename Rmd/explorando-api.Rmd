...
ggplot() +
    ...
    geom_jitter(data = dados.grafico.extremos, aes(x = hora, y = n_smooth, group = dia, color = atividade.media), alpha = 0.35, size = 1.3, width = 0.3, height = 0.3) +
    annotate("text", label = "ATIVIDADE NO LSD", x = 20, y = 45, size = 10, family = "Helvetica", fontface = "bold", color = "#21908CFF") +
    annotate("text", label = "quantidade de pessoas ao longo do dia", x = 20, y = 37, size = 5, family = "Helvetica", color = "gray70") +
