...
p <- suavizada %>%
    filter(year(periodo) == 2016) %>%
    ggplot(aes(x = hora, y = n_smooth, group = dia, color = month(periodo))) + 
    geom_hline(alpha = 0.5, yintercept = c(1, 5, 15, 28, 45, 75, 120), colour = "grey90", size = 3) +
    geom_line(alpha = .15, size = .7) +
    annotate("text", label = "1", x = 20, y = 1, size = 7, family = "Helvetica", fontface = "bold", color = "gray40") +
    annotate("text", label = "5", x = 20, y = 5, size = 7, family = "Helvetica", fontface = "bold", color = "gray80") +
    annotate("text", label = "15", x = 20, y = 15, size = 7, family = "Helvetica", fontface = "bold", color = "gray40") +
    annotate("text", label = "30", x = 20, y = 30, size = 7, family = "Helvetica", fontface = "bold", color = "gray40") +
    annotate("text", label = "45", x = 20, y = 45, size = 7, family = "Helvetica", fontface = "bold", color = "gray40") +
    annotate("text", label = "75", x = 20, y = 75, size = 7, family = "Helvetica", fontface = "bold", color = "gray40") +
